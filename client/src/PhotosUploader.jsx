    ...
    return (
        <>
            <div className="flex gap-2">
                <input type="text" value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} placeholder="链接上传" />
                <button onClick={addPhotoByLink} className="bg-gray-200 px-4 rounded-2xl">添&nbsp;加</button>
            </div>
