        ...
        <div className="mt-4 grow flex items-center justify-around">
            <div className="mb-64">
                ...
                <form className="max-w-md mx-auto" onSubmit={registerUser}>
                    ...
                    <input type="text" placeholder="手机号码" value={phone} onChange={ev => setPhone(ev.target.value)} />
                    <input type="email" placeholder="您的邮箱" value={email} onChange={ev => setEmail(ev.target.value)} />
